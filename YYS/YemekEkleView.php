                            ...
                            <form enctype="multipart/form-data" id="uploadForm" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-3 col-sm-10">Yemek Adı:</label>
                                        <div class="col-lg-4">
                                            <input type="text" id="y_adi" name="y_adi" class="form-control"
                                                   placeholder=""/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            <input type="number" id="y_kalori" name="y_kalori" class="form-control"
                                                   placeholder=""/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class=" col-lg-4 col-md-9 col-sm-12">
                                            <select class="form-control " type="text" id="y_tur" name="y_tur">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary btn-shadow font-weight-bold btn-modal-tur" id="BtnModalTurEkle" data-dismiss="modal">Ekle</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card card-custom gutter-b example example-compact">
                                        <!--begin::Form-->
                                        <form enctype="multipart/form-data" name="imageform" role="form" id="imageform"
                                              method="post">
                                            <div class="card-body">
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Fotoğraf:</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <div class="image-input image-input-empty image-input-outline" style="background-image: url(assets/media/users/blank.png)">
                                                            <div class='preview' id="img">
                                                            <img class="image-input-wrapper" src="" id="img" width="100" height="100">
                                                            </div>
                                                            <label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow"
                                                                ...
                                                                <input class='file' type="file"
                                                                       name="ymk_fotograf" id="ymk_fotograf"
                                                                       accept=".png, .jpg, .jpeg" />
                                                                <!--  <input type="hidden" name="profile_avatar_remove"/>-->
                                                            </label>
                                                        </div>
                                                        <span class="form-text text-muted">Fotoğraf ekleyebilirsiniz.</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            <button class="btn btn-success mr-2" type="button" value="Upload" id="btn_Ykaydet">Kaydet</button>
                                            <!--<input type="submit" id="btnKaydet"  value="submit" class="btn btn-success mr-2">-->
                                            <button type="reset" id="btn_iptal" class="btn btn-secondary">İptal</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M17.9142136,15.4497475 C18.4664983,15.4497475 18.9142136,15.8974627 18.9142136,16.4497475 L18.9142136,18.4497475 C18.9142136,19.0020322 18.4664983,19.4497475 17.9142136,19.4497475 C17.3619288,19.4497475 16.9142136,19.0020322 16.9142136,18.4497475 L16.9142136,16.4497475 C16.9142136,15.8974627 17.3619288,15.4497475 17.9142136,15.4497475 Z M23.4497475,17.1568542 C23.8402718,17.5473785 23.8402718,18.1805435 23.4497475,18.5710678 L22.0355339,19.9852814 C21.6450096,20.3758057 21.0118446,20.3758057 20.6213203,19.9852814 C20.2307961,19.5947571 20.2307961,18.9615921 20.6213203,18.5710678 L22.0355339,17.1568542 C22.4260582,16.76633 23.0592232,16.76633 23.4497475,17.1568542 Z M12.6213203,17.1568542 C13.0118446,16.76633 13.6450096,16.76633 14.0355339,17.1568542 L15.4497475,18.5710678 C15.8402718,18.9615921 15.8402718,19.5947571 15.4497475,19.9852814 C15.0592232,20.3758057 14.4260582,20.3758057 14.0355339,19.9852814 L12.6213203,18.5710678 C12.2307961,18.1805435 12.2307961,17.5473785 12.6213203,17.1568542 Z"
              ...
              transform="translate(18.035534, 17.863961) scale(1, -1) rotate(45.000000) translate(-18.035534, -17.863961) "/>
                                ...
                                <div class="d-flex flex-column flex-grow-1 mr-2">
                                    <a href=""
                                       class="font-weight-normel text-dark-75 text-hover-primary font-size-lg mb-1"></a>
...
<script type="text/javascript">
    ...
    function turListele() {
        ...
        var sel = document.getElementById("y_tur");
        var options_str = "";
    ...
    $(document).ready(function () {
        ...
        //Yemek Kayıt Ekleme
        $("#btn_Ykaydet").click(function () {
            //alert("ButtonClick");

            var fd = new FormData();
            var y_adi=$("input[name=y_adi]").val();
            var y_kalori=$("input[name=y_kalori]").val();
            var y_tur=$("select[name=y_tur]").val();
            var files = $('#ymk_fotograf')[0].files;




             if(files.length>0){
                fd.append('ymk_fotograf',files[0]);
                fd.append('y_adi',y_adi);
                fd.append('y_kalori',y_kalori);
                fd.append('y_tur',y_tur);
                ...
                $.ajax({
                    ...
                    success:function (result){
                             $("input[name=y_adi]").val("");
                             $("input[name=y_kalori]").val("");
                             $("select[name=y_tur]").val("");
                             console.log(result);
                             Swal.fire(
                                 {
                                     position: 'top-right',
                 ...
                 alert("Lütfen yemek fotoğrafı yükleyin.");
             }
