...
<div class="food_section layout_padding">
    <div class="" >
        <div class="heading_container heading_center">
            ...
            <h1 style="font-size: 50px; margin-bottom: 20px; margin-top: 5px">
                Aylık Yemek Menüsü
        ...
        <div class="filters-content" style=" margin-left: 350px; margin-right: 350px; margin-top: 1px ">




            <table class="table table-dark table-active"  style="" id="aylikMenu_datatable">
                <thead>
                <tr class="noExl">
...
<script>
    ...
    $("#btn_Exel").click(function(){
        $("#aylikMenu_datatable").table2excel({
            exclude: ".noExl",
            name: "AylikMenu",
            filename: "ExportUsers"
        });
    });
</script>