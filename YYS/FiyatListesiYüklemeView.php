...
<head>
    ...
    <link href="assets/plugins/custom/uppy/uppy.bundle.css?v=7.0.6" rel="stylesheet" type="text/css"/>
                            ...
                            <form enctype="multipart/form-data" id="uploadForm" method="POST">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label text-right col-lg-3 col-sm-10">Yıl:</label>
                                        <div class=" col-lg-4 col-md-5 col-sm-10">
                                            <select class="form-control " type="text" id="tarih" name="tarih">
...
<!--                                                <input type="text" id="tarih" name="tarih" class="form-control form-control-solid datetimepicker-input" placeholder="" data-target="#kt_datetimepicker_3"/>-->
...
<!---->
<!--                                            </div>-->
<!--                                            <span class="form-text text-muted">Belgenin geçerli olduğu ilk tarihi giriniz.</span>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 col-form-label text-right">Fiyat Listesi:</label>
                                                    <div class="col-lg-4 col-md-5 col-sm-10">
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" id="inputFile" aria-describedby="">
                                                            <label class="custom-file-label" id="labelFile" for="inputFile">Seçiniz</label>
                                                        </div>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                        <div class="col-lg-9 ml-lg-auto">
                                            <button class="btn btn-success mr-2" type="button" value="Upload" id="btn_Fkaydet" >Kaydet</button>
...
<script type="text/javascript">
    ...
    $("#btn_Fkaydet").click(function () {
            ...
            if(files.length>0){
                fd.append('dosya',files[0]);
                fd.append('tarih',tarih);



                $.ajax({
                    url: "FiyatListesiYükleme.php",
                    type: "POST",
                    data:fd,
                    contentType: false,
                    processData: false,
                    success:function (result){
                        ...
                        if (result !== tarih + " yılına ait belge bulunmaktadır.") {

                            console.log(result);
                            document.getElementById("uploadForm").reset();
                            document.getElementById("labelFile").innerHTML ="Seçiniz";
                            Swal.fire(
                                {
                                    position: 'top-right',
                                    icon: 'info',
