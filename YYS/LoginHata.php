...
<head><base href="">
    ...
    <link href="assets/css/pages/error/error-5.css?v=7.0.6" rel="stylesheet" type="text/css"/>
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="error error-5 d-flex flex-row-fluid bgi-size-cover bgi-position-center" style="background-image: url(assets/media/error/bg5.jpg);">
        ...
        <div class="container d-flex flex-row-fluid flex-column justify-content-md-center p-12">
            <h1 class="error-title font-weight-boldest text-info mt-10 mt-md-0 mb-12">!!!</h1>
            <p class="font-weight-boldest display-4">
                Başarısız oturum açma işlemi.
            </p>
