...
<!--                <form>-->
                    ...
                    <div class="pb-5 pb-lg-15">
                        <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">E-posta Adresinizi Girin</h3>
                    </div>
                    <!--begin::Title-->
                ...
                <form action="Login.php" method="post">
                    ...
                    <div class="form-group"><label class="font-size-h6 font-weight-bolder text-dark" ></label>
                        <label>
                            <input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg border-0" type="text" name="kAdi" autocomplete="off" placeholder="E-posta"/>
                        </label>
                    </div>
                    <!--end::Form group-->
                    ...
                    <div class="pb-lg-0 pb-5">
                        <button type="submit" id="btn_Giris" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3" >Gönder</button>
                    </div>
                    <!--end::Action-->
                </form>
                <!--end::Form-->
    ...
    <div class="login-aside order-1 order-lg-2 bgi-no-repeat bgi-position-x-right">
        <div class="login-container bgi-no-repeat bgi-position-x-right bgi-position-y-bottom" style="background-image: url(assets/media/svg/illustrations/login-visual-4.svg);">
            <!--begin::Aside title-->
